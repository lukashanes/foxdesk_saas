...
function openTicketTimeline(ticketId) {
    ...
    content.innerHTML = '<div class="ticket-timeline-empty"><?php echo e(t('Loading...')); ?></div>';
    ...
    .then(function(data) {
        if (!data.success || !data.events || !data.events.length) {
            content.innerHTML = '<div class="ticket-timeline-empty"><?php echo e(t('No activity found')); ?></div>';
            return;
        }
        var html = '';
        data.events.forEach(function(ev) {
            ...
            if (ev.type === 'change' && (ev.old_value || ev.new_value)) {
                ...
                if (ev.old_value) html += '<span class="tl-old">' + escTlHtml(ev.old_value) + '</span>';
                html += '<span class="tl-arrow">→</span>';
                if (ev.new_value) html += '<span class="tl-new">' + escTlHtml(ev.new_value) + '</span>';
                html += '</div>';
            }
            if (ev.detail) {
    ...
    .catch(function() {
        content.innerHTML = '<div class="ticket-timeline-empty"><?php echo e(t('Error loading timeline')); ?></div>';
    });
}

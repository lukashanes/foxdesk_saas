...
$assert(!str_contains($iosDashboardView, 'NewTicketView'), 'iOS Dashboard must not duplicate the bottom New ticket tab.');
$assert(!str_contains($iosDashboardView, 'DashboardTicketRoute'), 'iOS Dashboard must not own a dashboard-only created-ticket route.');
$assert(!str_contains($iosDashboardView, 'ToolbarItem'), 'iOS Dashboard must not show top add/reload toolbar buttons.');
$assert(str_contains($iosDashboardView, '.refreshable'), 'iOS Dashboard must keep pull-to-refresh.');
...
$assert(str_contains($iosDashboardIdentitySectionsView, 'Section("In progress now")'), 'iOS Dashboard active timers must be labelled as in-progress work.');
...
$assert(!str_contains($iosDashboardQuickActionsView, 'NotificationsView()'), 'iOS Dashboard must not duplicate notification navigation.');
$assert(!str_contains($iosDashboardQuickActionsView, '.badge(unreadCount)'), 'iOS Dashboard must not duplicate unread badges outside the native notification surfaces.');

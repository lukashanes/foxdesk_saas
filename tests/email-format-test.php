...
assert_email_format_contains($converted, "Hello Alex,\n\nwe need these items:");
...
$selected = email_ingest_select_display_body('Hello Alex, we need these items: first task second task Status Open Regards Support', email_ingest_sanitize_html($html));

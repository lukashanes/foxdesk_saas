<?php
/**
 * Production config template for Hetzner + Cloudflare.
 * Copy to deploy/hetzner/config.php on the server and keep it out of git.
 */
...
define('DB_NAME', foxdesk_env('DB_NAME', 'foxdesk_prod'));
...
define('APP_URL', rtrim((string) foxdesk_env('APP_URL', 'https://app.foxdesk.net'), '/'));
...
define('BILLING_CLOUD_BASE_PRICE_CENTS', (int) foxdesk_env('BILLING_CLOUD_BASE_PRICE_CENTS', 1900));
define('BILLING_STORAGE_OVERAGE_PRICE_CENTS', (int) foxdesk_env('BILLING_STORAGE_OVERAGE_PRICE_CENTS', 79));
